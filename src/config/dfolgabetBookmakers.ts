...
export const DFOLOGABET_PRIORITY_BOOKMAKERS: BookmakerConfig[] = [
  ...
  { key: '1xbet', label: '1xBet', slug: '1xbet', priority: 184, affiliateUrl: 'https://1xbet.bet.br/pt', logo: '/assets/optimized/1xbet_logo_cinematic.webp', enabled: true, bonus: 'Oferta Especial', rating: 4.8, hasOddsAPI: false },
