        ...
        <div className="flex items-center justify-center md:justify-start gap-4">
          ...
          {name.includes('Erico') && (
            <>
              <a
                ...
                className="text-gray-400 hover:text-[#50C0CC] transition-colors"
                title="Facebook"
                aria-label="Facebook"
              >
                <Facebook size={20} />
              ...
              <a
                href="https://www.instagram.com/ericogomes50/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#50C0CC] transition-colors"
                title="Instagram"
              ...
              <a
                href="https://www.linkedin.com/in/erico-gomes-redator-seo/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#50C0CC] transition-colors"
                title="LinkedIn"
          ...
          >
            <img
              ...
              alt="uTimeOff"
              loading="lazy"
              className="w-full h-full object-contain absolute inset-0 opacity-100 group-hover:opacity-0 transition-opacity"
              onError={(e) => {
            ...
            <div
              ...
              style={{
                maskImage: `url(/assets/logos/partners/utimeoff-logo.png)`,
                maskSize: 'contain',
                maskRepeat: 'no-repeat',
                maskPosition: 'center',
                WebkitMaskImage: `url(/assets/logos/partners/utimeoff-logo.png)`,
